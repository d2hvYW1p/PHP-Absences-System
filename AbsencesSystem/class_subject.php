        ...
        <div class="card">
          <div class="card-header">
            ...
            <span class="float:right">
              <a class="btn btn-primary btn-block btn-sm col-sm-2 float-right" href="javascript:void(0)" id="new_class_subject">
            ...
            <table class="table table-condensed table-bordered table-hover">
              ...
              <tbody> <?php 
                  ...
                  <td class="text-center">
                    ...
                    <button class="btn btn-sm btn-outline-danger delete_class_subject" type="button" data-id="
